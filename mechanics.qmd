...
:::
::: {.column width="100%"}
{{< fa building-columns >}} **Venue:** {{< var course.where-long >}}
:::
::: {.column width="100%"}
{{< fa file-signature >}} **Registration:** The registration period starts on {{< var project.registration-start >}} and ends on {{< var project.registration-end >}}.
:::
::::
```{r}
```
