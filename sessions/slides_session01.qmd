...
1. Optional: Your mood on a sheep scale?
:::
::: {.column width="60%"}
::: {.fragment}
...
:::: {.columns}
::: {.column width="50%"}
- {{< fa calendar-days >}} **Date:** {{< var project.when-day >}}, {{< var project.when-date >}}
- {{< fa clock >}} **Time:** {{< var project.when-time >}}
- {{< fa building-columns >}} **Room:** {{< var project.where-room >}}
:::
::: {.column width="50%"}
- {{< fa person-chalkboard >}} **Instructor:** [{{< var project.instructors >}}]({{< var team.lennart.website >}})
- {{< fa chalkboard >}} **Event:** Course ({{< var project.duration >}})
...
::: {.fragment}
{{< fa clock >}} The course will consist of 6 main sessions (ca. 45 - 60 minutes each)
:::
